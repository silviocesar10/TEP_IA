...
X = df[['X', 'Y']] # variáveis de entrada
y = df['Classe'] # classes de saída

# Dividir os dados em conjuntos de treino e teste
# random_state é a semente para a divisão aleatória entre treino e teste
...
novas_amostras = [[10, 5], [30, 20]]
# Fazer previsões para novas amostras
novas_predicoes = knn.predict(novas_amostras)
# Transformar de volta para as etiquetas originais
novas_predicoes = le.inverse_transform(novas_predicoes)
