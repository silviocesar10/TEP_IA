...
def load_images_and_labels(folder, label):
    ...
    for filename in os.listdir(folder):
        ...
        img = cv2.resize(img, (28, 28))  # Redimensiona para 1024x1024 pixels
...
# Adaptação do modelo para lidar com imagens maiores
...
# Avaliação do modelo
accuracy = model.evaluate(x_test.reshape(-1, 1024, 1024, 1), y_test, verbose=2)[1]
